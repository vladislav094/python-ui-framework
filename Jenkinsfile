        ...
        stage("create docker image") {
            steps {
                echo "========== start building image =========="
                   ...
                   sh "pytest -s tests/negative_tests/test_authorization_user_negative.py::TestAuthorizationRegistrationNegative::test_authorization_with_invalid_credentials_negative --alluredir=allure_reports"
